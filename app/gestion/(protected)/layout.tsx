      ...
      <main className="admin-main" style={{ flex: 1, minWidth: 0 }}>
        <style>{`
          ...
          @media (min-width: 769px) {
            body > div, #__next > div { flex-direction: row !important; }
            .admin-main { margin-left: 240px; overflow-y: auto; }
          }
          ...
          th { text-align:left; font-size:0.7rem; font-weight:700; color:#94A3B8; text-transform:uppercase; letter-spacing:0.06em; padding:10px 14px; border-bottom:1px solid #E2E8F0; white-space: nowrap; }

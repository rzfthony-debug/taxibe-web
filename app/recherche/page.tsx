    ...
    <>
      ...
      <style>{`
        ...
        .sticky-bar {
          ...
          padding: 12px 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.06);
        }
        ...
        @media (max-width: 900px) {
          ...
          .section-pad { padding: 0 20px 32px; }
        }
        @media (max-width: 540px) {
          .features-row { grid-template-columns: 1fr; }
          .ligne-chip { width: 62px; height: 62px; font-size: 1rem; }
        }
      ...
      <div style={{ background: "white", minHeight: "100vh" }}>
              ...
              <div>
                ...
                <form action="/recherche" method="GET">
                  <div className="search-bar-hero">
                    ...
                    <input name="q" placeholder="Numéro de ligne (ex : 147)" autoComplete="off" />
        ...
        {/* ── LIGNES POPULAIRES ────────────────────────────────── */}
        {!query && (
          <section style={{ background: "white", padding: "36px 48px 32px" }}>
        ...
        {query && (
          <div className="sticky-bar">
            <div style={{ maxWidth: 860, margin: "0 auto" }}>
              <form action="/recherche" method="GET">
                <div className="search-bar-hero" style={{ height: 48, borderRadius: 10, maxWidth: "100%" }}>
                  <span className="search-icon-wrap" style={{ padding: "0 12px" }}>
                  ...
                  <button type="submit" className="search-btn" style={{ fontSize: "0.85rem", padding: "0 20px" }}>
                    Chercher
                  </button>
                </div>
              </form>
          ...
          <div style={{ maxWidth: 860, margin: "0 auto", padding: "28px 24px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {results.map((ligne) => {
                ...
                return (
                  <div key={ligne.id} className="result-card" style={{ background: "white", borderRadius: 12, border: "1px solid #E8ECF0", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
                    <div style={{ flexShrink: 0, background: color, color: "white", fontWeight: 900, fontSize: "1rem", padding: "8px 14px", borderRadius: 8, minWidth: 60, textAlign: "center", letterSpacing: "0.02em", boxShadow: `0 2px 8px ${color}40` }}>
                      {ligne.numero}
                    </div>
                    <div className="result-trajet" style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: "flex", gap: 12, marginTop: 5 }}>
                        {ligne.cooperative && <span style={{ fontSize: "0.75rem", color: "#94A3B8", fontWeight: 500 }}>{ligne.cooperative}</span>}
                        <span style={{ fontSize: "0.75rem", color: "#94A3B8" }}>{ligne.nb_arrets} arrêt{ligne.nb_arrets > 1 ? "s" : ""}</span>
                      </div>
                    </div>
